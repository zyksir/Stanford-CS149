...
void Logger::printStats() {
  ...
  printf("Vector Width\tTotal Vector Instructions\tVector Utilization\tUtilized Vector Lanes\tTotal Vector Lanes\n");
  printf("%d\t%lld\t%.1f%%\t%lld\t%lld\n", 
    VECTOR_WIDTH, stats.total_instructions, (double)stats.utilized_lane/stats.total_lane*100,
    stats.utilized_lane, stats.total_lane);
